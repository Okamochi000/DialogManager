...
public class OpenAndCloseBase : MonoBehaviour
{
    ...
    [SerializeField] private OpenAnimType openAnimType = OpenAnimType.None;
    ...
    public bool IsOpen()
    {
        return (CurrentOpenState == OpenState.OpenAnim && CurrentOpenState == OpenState.CloseAnim);
    }
    ...
    /// </summary>
    /// <param name="state"></param>
    protected void OnChangedOpenState(OpenState state) { }
